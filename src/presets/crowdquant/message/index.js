    ...
    root: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-red-100/70 dark:bg-black/20': props.severity == 'error'
            },
            {
                ...
                'border-red-500 dark:border-[#df0000]': props.severity == 'error'
            },
            {
                ...
                'text-red-700 dark:text-white': props.severity == 'error'
            }
        ]
    }),
    wrapper: {
