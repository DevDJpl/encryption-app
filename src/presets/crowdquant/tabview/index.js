        ...
        headerAction: ({ parent, context }) => ({
            class: [
                ...
                // Colors and Conditions
                {
                    ...
                    'bg-surface-0 dark:bg-[#1e2d4b]': parent.state.d_activeIndex !== context.index,
                    'text-surface-700 dark:text-surface-0/80': parent.state.d_activeIndex !== context.index,

                    // eslint-disable-next-line no-dupe-keys
                    'bg-surface-0 dark:bg-[#1e2d4b]': parent.state.d_activeIndex === context.index,
                    'border-primary-500 dark:border-[#2196f3]': parent.state.d_activeIndex === context.index,
                    'text-primary-500 dark:text-[#2196f3]': parent.state.d_activeIndex === context.index
                },
                ...
                {
                    'hover:bg-surface-0 dark:hover:bg-[#1e2d4b]/80': parent.state.d_activeIndex !== context.index,
                    'hover:border-surface-400 dark:hover:border-[#2196f3]': parent.state.d_activeIndex !== context.index,
