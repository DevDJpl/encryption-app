    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            },
            {
                ...
                'w-9 h-9 p-0 py-2': props.size === 'small'
            },
            ...
            // Primary Button
            {
                ...
                'bg-primary-500 dark:bg-[#2196f3]': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'border border-primary-500 dark:border-[#2196f3]': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // Primary Text Button
            ...
            // Secondary Button
            {
                'text-white dark:text-white-800': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                'bg-surface-500 dark:bg-[#131a28]': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                'border border-surface-500 dark:border-[#131a28]': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
            },
            ...
            // Danger Text Button
            { 'text-red-500 dark:text-[#df0000]': props.text && props.severity === 'danger' && !props.plain },
            ...
            // Primary
            { 'hover:bg-primary-600 dark:hover:bg-[#249ffc] hover:border-primary-600 dark:hover:border-[#249ffc]': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain },
            ...
            // Secondary
            { 'hover:bg-surface-600 dark:hover:bg-[#17202d] hover:border-surface-600 dark:hover:border-[#17202d]': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain },
            ...
            // Text & Outlined Button
            { 'hover:bg-[#bf1b1b]/20': (props.text || props.outlined) && props.severity === 'danger' && !props.plain },
