    ...
    stepperpanel: {
        ...
        number: ({ context }) => ({
            class: [
                ...
                // Colors (Conditional)
                context.active ? 'bg-primary-500 dark:bg-[#2196f3] text-surface-0 dark:text-white' : 'border border-surface-200 dark:border-surface-700 text-surface-900 dark:text-surface-0', // Adjust colors as needed
        ...
        separator: ({ context, state, parent }) => ({
            class: [
                ...
                state.d_activeStep <= context.index ? 'bg-surface-200 dark:bg-surface-700' : 'bg-primary-500 dark:bg-[#2196f3]',
